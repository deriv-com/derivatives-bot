    ...
    toActiveSymbols(activeSymbolsData: any[]): ActiveSymbol[] {
        ...
        for (const symbol of activeSymbolsData) {
            ...
            symbols.push({
                ...
                subgroup: symbol.submarket, // Map submarket to subgroup
                subgroup_display_name: symbol.submarket_display_name, // Map submarket_display_name to subgroup_display_name
    ...
    const adapter: SmartchartsChampionAdapter = {
        ...
        unsubscribeQuotes(request: TGetQuotesRequest): void {
            ...
            if (unsubscribe) {
                ...
                console.warn('No active subscription found for:', subscriptionKey);
            }
        },
