    ...
    return {
            ...
            chart_api.api
                ...
                .then((response: any) => {
                    ...
                    if (subscriptionId) {
                        ...
                        console.error('❌ [Transport] No subscription ID in response:', response);
                    }
                })
                .catch((error: any) => {
                    console.error('❌ [Transport] Subscription failed:', error);
        ...
        unsubscribe(subscriptionId: string): void {
            ...
            if (subscription) {
                ...
                console.warn('⚠️ [Transport] No subscription found for ID:', subscriptionId);
            }
        },
